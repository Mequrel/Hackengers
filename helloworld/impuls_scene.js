		...
		if (score > 1000){
			...
			if (viewMode == 0) {
				...
				goog.events.listen(anim,lime.animation.Event.STOP,function(e){
					...
					console.log('OK!');
					_this.scheduleAll(false);
					director.pushScene(new helloworld.FacebookScene(director,friends,helloworld.ImpulsScene,menuSceneType,score,true,"I've played Hackengers and chased the data!","Remember, that in real world you have to be careful what you publish!"),lime.transitions.SlideInUp,2);
